...
const PANELS = ['panel-dashboard', 'panel-bets', 'panel-dashboard-lecturer', 'panel-groups', 'panel-help', 'panel-dashboard-admin', 'panel-delete-request', 'panel-user-management', 'panel-madibucks', 'panel-accounting', 'panel-admin-groups', 'panel-reports', 'panel-settings', 'panel-query', 'panel-account'];
...
/* ────────────────────────────────────────────────────────────
 * B-series (Kieran): Bets panel (B700/B100/B200) and admin
 * Accounting System panel (B300/B400/B500/B600).
 * Endpoints live in web/BetApiHandler.java on the Java side.
 * ──────────────────────────────────────────────────────────── */

// The Bet table has no category column (known schema gap): the type rides
// inside the description as a "Type: ..." prefix, added by the propose form.
